...
{{< figure src="img/2007-navigation/flickr-menu.jpg" alt="The 2007 Flickr navigation bar with the Contacts menu open, showing Latest Photos, Contact List, People Search, Invite your Friends and Invite History." >}}
...
{{< figure src="img/2007-navigation/firefox-tabs.jpg" alt="Firefox 2 showing a row of open tabs beneath the address bar — a Google search, WordPress, and two others." >}}
...
{{< figure src="img/2007-navigation/wordpress-tabs.jpg" alt="The 2007 WordPress admin interface, with a row of parent tabs and a second row of child tabs beneath it." >}}
...
{{< figure src="img/2007-navigation/nested-menu.jpg" alt="A menu with a submenu opened out from one of its items." >}}
...
{{< figure src="img/2007-navigation/desktop-context-menu.jpg" alt="The Windows right-click menu on an empty area of the desktop." >}}

However, if you right click on a item ON the desk top, you get this

{{< figure src="img/2007-navigation/item-context-menu.jpg" alt="The Windows right-click menu on a desktop icon, showing a different set of options from the empty-desktop menu." >}}
