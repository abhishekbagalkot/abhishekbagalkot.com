...
{{< figure src="img/product-strategy-pillars.png" alt="A diagram drawn as a building: value proposition as the foundation, three pillars labelled customer segments, customer journey and customer benefits, and a roof labelled product strategy." >}}
...
{{< figure src="img/customer-journey-uber.png" alt="A grid comparing two customer segments — planned bookings and impulse bookings — across five stages: feel the need, search for options, make booking, consume service, make payment. Points of dissatisfaction are marked in colour." >}}
